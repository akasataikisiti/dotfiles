...
map Q gq
nnoremap \l :UltiSnipsListSnippets
nnoremap \T :echo tagbar#currenttag('[%s]', 'No tags')
nnoremap \t :TagbarOpenAutoClose
nnoremap \d "_d
nnoremap \m :MRU
nnoremap \cv :e ~/dotfiles/cheatsheets/vim.txt
nnoremap \ev :e ~/dotfiles/.vimrc
...
silent only
silent tabonly
cd /mnt/d/勉強用ワークスペース/youtuber/moji_typing
...
silent! normal! zE
let s:l = 92 - ((42 * winheight(0) + 24) / 49)
...
tabnext 1
badd +881 typing.js
badd +62 ~/dotfiles/cheatsheets/vim.txt
badd +9 typing.html
badd +51 ~/dotfiles/.vimrc
badd +0 ~/.vim/UltiSnips/javascript.snippets
badd +4 memo
